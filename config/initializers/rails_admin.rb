# RailsAdmin config file. Generated on May 22, 2013 10:30
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Coming Elections', 'Admin']
  ...
  # config.excluded_models = ['Election']

  # Include specific models (exclude the others):
  # config.included_models = ['Election']
